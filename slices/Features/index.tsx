...
const Features = ({ slice }: FeaturesProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="flex max-w-5xl gap-x-8 gap-y-12 mx-auto sm:items-start items-center">
        {slice.items.map((item, index) => (
          <div key={index} className="max-w-xs flex flex-col items-center sm:items-start">
